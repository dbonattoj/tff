...
template<std::size_t Input_dim, typename Input_elem>
void enclosure_filter_input<Input_dim, Input_elem>::attach_internal_input(internal_input_type& in) {
...
template<std::size_t Input_dim, typename Input_elem>
void enclosure_filter_input<Input_dim, Input_elem>::detach_internal_input(internal_input_type& in) {
